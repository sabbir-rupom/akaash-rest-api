...
console.log(c.getAllResponseHeaders());$("#responseHeader").html(c.getAllResponseHeaders().replace(/\n/g,"<br/>"))}}).fail(function(a,b,c){a.hasOwnProperty("responseJSON")?a=a.responseJSON:a.hasOwnProperty("responseText")&&(a=a.responseText);a=JSON.stringify(a,null,2);$("#jsonOutput").css("background-color","rgb(251, 205, 183)");$("#jsonOutput").text(syntaxHighlight(a));$("#responseHeader").html(c.getAllResponseHeaders().replace(/\n/g,"<br/>"))}):alert("invalid JSON")})});
