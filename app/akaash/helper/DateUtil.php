...
class DateUtil
{
     ...
     */
    public static function dateDifference($toDate, $fromDate, $differenceFormat = '%a')
    {
    ...
    /**
     * Data to be displayed on the application side is acquired "hh: mm" on the day of acquisition,
     * "MM / DD" not on the day
     *
     * @param string $date
     * @return string formatted date
     */
