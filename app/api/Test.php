...
class Test extends BaseClass {
    ...
    public function action() {
        ...
        if (Config_Config::getInstance()->isCacheEnable()) {
        ...
        $profileImagePath = System_Constant::UPLOAD_PROFILE_IMAGE_PATH;
        if (!file_exists($profileImagePath) && !is_dir($profileImagePath)) {
            ...
            if (!is_writable($profileImagePath)) {
                ...
                $responseArray['testImagUrl'] = SERVER_HOST . "/uploads/profile_images/" . Model_FileUpload::processBinaryImage('test', $imgBase64Data, 'profile', TRUE);
