    ...
    public function action() {
        ...
        if (!file_exists($profileImagePath) && !is_dir($profileImagePath)) {
            ...
            if (!is_writable($profileImagePath)) {
                ...
                $responseArray['testImagUrl'] = SERVER_HOST . DIRECTORY_SEPARATOR . "uploads" 
                        . DIRECTORY_SEPARATOR . 'profile_images' . DIRECTORY_SEPARATOR . $this->process_binary_image('test', $imgData, 'profile', TRUE);
            }
        }
